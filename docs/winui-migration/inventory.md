...
| `main.rs` | `src-tauri/src/main.rs` | Windows subsystem, panic log to `%LOCALAPPDATA%\SimpleFile\startup.log` | Light |
...
| Log | `%LOCALAPPDATA%\SimpleFile\startup.log` | `main.rs` | Panic hook |
