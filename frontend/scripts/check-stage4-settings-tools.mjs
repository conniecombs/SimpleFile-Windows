...
assertContains('frontend/src/lib/components/settings-body/SettingsBody.svelte', [
  ...
  'id="settings-column-preset"',
  'id="settings-column-manager"',
  'id="settings-columns-reset"',
  'id="settings-photo-folder-mode"',
  'id="settings-photo-folder-threshold"',
  'id="settings-photo-icon-size"',
