...
//#endregion
//#region src/lib/components/archive-surfaces/ArchiveContents.svelte
var root$2 = /* @__PURE__ */ from_html(`<div class="archive-entry archive-item archive-empty">No archive entries</div>`);
var root_1$1 = /* @__PURE__ */ from_html(`<div class="archive-entry archive-item"><span class="icon archive-icon" aria-hidden="true"> </span> <span class="name archive-name"> </span> <span class="size archive-size"> </span></div>`);
function ArchiveContents($$anchor, $$props) {
	push($$props, true);
	...
	var alternate = ($$anchor) => {
		...
		each(first_child(fragment_1), 19, entries, (entry, index) => entryKey(entry, index), ($$anchor, entry) => {
			var div_1 = root_1$1();
			...
			template_effect(($0, $1, $2) => {
				set_attribute(div_1, "data-path", get(entry).path ?? "");
				set_text(text, $0);
				set_text(text_1, $1);
				set_text(text_2, $2);
			}, [
				() => isDirectory(get(entry)) ? "📁" : "📄",
				() => entryName(get(entry)),
				() => isDirectory(get(entry)) ? "-" : formatSize(get(entry).size)
			]);
			append($$anchor, div_1);
		});
	...
	if_block(node, ($$render) => {
		if (entries().length === 0) $$render(consequent);
...
//#endregion
//#region src/lib/components/archive-surfaces/ArchiveInfo.svelte
var root$1 = /* @__PURE__ */ from_html(`<div class="archive-info-item"><span class="archive-info-label">Archive</span> <span class="archive-info-value"> </span></div> <div class="archive-info-item"><span class="archive-info-label">Entries</span> <span class="archive-info-value"> </span></div> <div class="archive-info-item"><span class="archive-info-label">Total Size</span> <span class="archive-info-value"> </span></div> <div class="archive-info-item"><span class="archive-info-label">Packed</span> <span class="archive-info-value"> </span></div> <div class="archive-info-item"><span class="archive-info-label">Format</span> <span class="archive-info-value"> </span></div>`, 1);
function ArchiveInfo($$anchor, $$props) {
	push($$props, true);
	let archivePath = prop($$props, "archivePath", 3, ""), compressedSize = prop($$props, "compressedSize", 3, null), entries = prop($$props, "entries", 19, () => []), format = prop($$props, "format", 3, ""), totalSize = prop($$props, "totalSize", 3, null);
	function formatSize(bytes) {
		const value = Number(bytes ?? 0);
		if (!Number.isFinite(value) || value <= 0) return "0 B";
		const units = [
	...
	function archiveName() {
		if (!archivePath()) return "Archive";
		return archivePath().split("\\").join("/").split("/").filter(Boolean).pop() || archivePath();
	}
	function entryCount() {
	...
	var span_3 = sibling(child(div_3), 2);
	var text_3 = child(span_3, true);
	reset(span_3);
	reset(div_3);
	var div_4 = sibling(div_3, 2);
	var span_4 = sibling(child(div_4), 2);
...
//#endregion
//#region src/lib/components/archive-surfaces/CreateArchiveBody.svelte
var root = /* @__PURE__ */ from_html(`<option> </option>`);
var root_1 = /* @__PURE__ */ from_html(`<div class="archive-file-item"><span class="icon" aria-hidden="true">📄</span> <span>No files selected</span></div>`);
var root_2 = /* @__PURE__ */ from_html(`<div class="archive-file-item"><span class="icon" aria-hidden="true">📄</span> <span> </span></div>`);
var root_3 = /* @__PURE__ */ from_html(`<div class="form-group"><label class="form-label" for="archive-name">Archive Name:</label> <input type="text" class="form-input" id="archive-name" placeholder="archive.zip"/></div> <div class="form-group"><label class="form-label" for="archive-format">Format:</label> <select class="form-input" id="archive-format"></select></div> <div class="form-group"><label class="form-label" for="archive-files-list">Files to compress:</label> <div id="archive-files-list" class="archive-files-preview"><!></div></div>`, 1);
function CreateArchiveBody($$anchor, $$props) {
	push($$props, true);
	let defaultName = prop($$props, "defaultName", 3, "archive.zip"), format = prop($$props, "format", 3, "zip"), selectedNames = prop($$props, "selectedNames", 19, () => []);
	const formats = [
		{
			label: "ZIP (.zip)",
			value: "zip"
	...
	each(select, 21, () => formats, (option) => option.value, ($$anchor, option) => {
		var option_1 = root();
		...
		template_effect(() => {
			...
			if (option_1_value !== (option_1_value = get(option).value)) option_1.value = (option_1.__value = get(option).value) ?? "";
		});
	...
	var alternate = ($$anchor) => {
		var fragment_1 = comment();
		each(first_child(fragment_1), 19, selectedNames, (name, index) => `${name}-${index}`, ($$anchor, name) => {
			var div_5 = root_2();
	...
	if_block(node, ($$render) => {
		if (selectedNames().length === 0) $$render(consequent);
		else $$render(alternate, -1);
	});
	reset(div_3);
	reset(div_2);
	template_effect(() => {
		set_value(input, defaultName());
		if (select_value !== (select_value = format())) select.value = (select.__value = format()) ?? "", select_option(select, format());
	});
	append($$anchor, fragment);
	pop();
}
//#endregion
//#region src/lib/components/archive-surfaces.ts
var mountedArchiveContents = /* @__PURE__ */ new WeakMap();
var mountedArchiveInfo = /* @__PURE__ */ new WeakMap();
var mountedCreateArchiveBodies = /* @__PURE__ */ new WeakMap();
function clearMounted(target, map, markerName) {
	if (!target) return;
	...
	if (markerName) delete target.dataset[markerName];
	target.replaceChildren();
}
function clearArchiveContents(target) {
	clearMounted(target, mountedArchiveContents, "svelteArchiveContents");
}
function renderArchiveContents(target, props = {}) {
	if (!target) return;
	...
	target.dataset.svelteArchiveContents = "true";
	mountedArchiveContents.set(target, component);
}
function clearArchiveInfo(target) {
	clearMounted(target, mountedArchiveInfo, "svelteArchiveInfo");
}
function renderArchiveInfo(target, props = {}) {
	if (!target) return;
	...
	target.dataset.svelteArchiveInfo = "true";
	mountedArchiveInfo.set(target, component);
}
function clearCreateArchiveBody(target) {
	clearMounted(target, mountedCreateArchiveBodies, "svelteCreateArchiveBody");
}
function renderCreateArchiveBody(target, props = {}) {
	if (!target) return;
	...
	target.dataset.svelteCreateArchiveBody = "true";
	mountedCreateArchiveBodies.set(target, component);
}
//#endregion
export { clearArchiveContents, clearArchiveInfo, clearCreateArchiveBody, renderArchiveContents, renderArchiveInfo, renderCreateArchiveBody };
