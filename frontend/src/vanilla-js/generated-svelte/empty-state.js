...
//#endregion
//#region src/lib/components/empty-state/EmptyState.svelte
var root = /* @__PURE__ */ from_html(`<div> </div>`);
function EmptyState($$anchor, $$props) {
	let className = prop($$props, "className", 3, "empty-state"), message = prop($$props, "message", 3, "This folder is empty");
	var div = root();
...
//#endregion
//#region src/lib/components/empty-state.ts
var mountedEmptyStates = /* @__PURE__ */ new WeakMap();
...
function renderEmptyMessage(target, options = {}) {
	if (!target) return;
...
function renderEmptyState(target, message = "This folder is empty") {
	renderEmptyMessage(target, {
		message,
		className: "empty-state"
	});
}
//#endregion
export { clearEmptyState, renderEmptyMessage, renderEmptyState };
