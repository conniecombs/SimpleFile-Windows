...
var root = /* @__PURE__ */ from_html(`<button type="button" class="column-resize-handle"></button>`);
var root_1 = /* @__PURE__ */ from_html(`<div role="columnheader" aria-sort="none" tabindex="0"><span> </span> <span class="sort-indicator" aria-hidden="true"></span> <!></div>`);
...
//#endregion
//#region src/lib/components/file-list-header.ts
var mountedFileListHeaders = /* @__PURE__ */ new WeakMap();
function clearFileListHeader(target) {
	if (!target) return;
	...
	delete target.dataset.svelteFileListHeader;
	target.replaceChildren();
}
function renderFileListHeader(target, props = {}) {
	if (!target) return;
	...
	target.dataset.svelteFileListHeader = "true";
	mountedFileListHeaders.set(target, component);
}
//#endregion
export { clearFileListHeader, renderFileListHeader };
