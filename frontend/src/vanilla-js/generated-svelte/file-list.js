...
//#endregion
//#region src/lib/components/file-list/FileListItems.svelte
var pdfIcon = ($$anchor) => {
	append($$anchor, root$1());
};
var tagBadge = ($$anchor, tag = noop) => {
	var span = root_1();
	var text = child(span, true);
	reset(span);
	template_effect(() => {
		set_style(span, `color: ${tag().color ?? ""};`);
		set_attribute(span, "title", `${tag().label} label`);
		set_attribute(span, "aria-label", `${tag().label} label`);
		set_text(text, tag().emoji);
	});
	append($$anchor, span);
};
var symlinkBadge = ($$anchor) => {
	append($$anchor, root_2());
};
var root$1 = /* @__PURE__ */ from_svg(`<svg class="file-pdf-icon" viewBox="0 0 48 56" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><path d="M6 0 L34 0 L42 8 L42 56 L6 56 Z" fill="#e53935" rx="2"></path><path d="M34 0 L42 8 L34 8 Z" fill="#ffcdd2"></path><rect x="34" y="0" width="8" height="8" fill="#ef9a9a"></rect><rect x="6" y="28" width="36" height="18" rx="2" fill="rgba(0,0,0,0.18)"></rect><text x="24" y="42" font-size="13" font-weight="700" fill="#ffffff" text-anchor="middle" font-family="Arial,Helvetica,sans-serif" letter-spacing="1">PDF</text></svg>`);
var root_1 = /* @__PURE__ */ from_html(`<span class="file-tag-badge"> </span>`);
var root_2 = /* @__PURE__ */ from_html(`<span class="symlink-badge" title="Symbolic link" aria-label="symlink">&#128279;</span>`);
var root_3 = /* @__PURE__ */ from_html(`<img class="file-thumbnail" alt=""/>`);
var root_4 = /* @__PURE__ */ from_html(`<div class="file-icon" aria-hidden="true"><!> <!> <!></div> <div class="file-name"> </div>`, 1);
var root_5 = /* @__PURE__ */ from_html(`<div class="file-cell size-col"> </div>`);
var root_6 = /* @__PURE__ */ from_html(`<div class="file-cell items-col"> </div>`);
var root_7 = /* @__PURE__ */ from_html(`<div class="file-cell date-col"> </div>`);
var root_8 = /* @__PURE__ */ from_html(`<div class="file-cell type-col"> </div>`);
var root_9 = /* @__PURE__ */ from_html(`<div class="file-cell name-col"><span class="file-icon" aria-hidden="true"> </span> <span class="file-name"> </span> <!> <!></div> <!> <!> <!> <!>`, 1);
var root_10 = /* @__PURE__ */ from_html(`<div role="option" draggable="true"><!></div>`);
var root_11 = /* @__PURE__ */ from_html(`<div class="virtual-spacer"><div></div></div>`);
var root_12 = /* @__PURE__ */ from_html(`<div class="grid-items-container"></div>`);
function FileListItems($$anchor, $$props) {
	push($$props, true);
	const fileItem = ($$anchor, item = noop) => {
		var div = root_10();
		var node = child(div);
		var consequent_4 = ($$anchor) => {
			...
			var consequent = ($$anchor) => {
				var img = root_3();
				template_effect(() => set_attribute(img, "src", `data:image/jpeg;base64,${item().thumbnail}`));
				append($$anchor, img);
			};
			...
			var alternate = ($$anchor) => {
				var text_1 = text();
				template_effect(() => set_text(text_1, item().icon));
				append($$anchor, text_1);
			};
			if_block(node_1, ($$render) => {
				if (item().thumbnail) $$render(consequent);
				else if (item().isPdf) $$render(consequent_1, 1);
			...
			if_block(node_2, ($$render) => {
				if (item().isSymlink) $$render(consequent_2);
			});
			var node_3 = sibling(node_2, 2);
			var consequent_3 = ($$anchor) => {
				tagBadge($$anchor, () => item().tag);
			};
			...
			reset(div_2);
			template_effect(() => {
				set_attribute(div_2, "title", item().name);
		...
		var alternate_1 = ($$anchor) => {
			...
			if_block(node_4, ($$render) => {
				if (item().isSymlink) $$render(consequent_5);
			});
			...
			if_block(node_5, ($$render) => {
				if (item().tag) $$render(consequent_6);
			});
			reset(div_3);
			...
			var consequent_7 = ($$anchor) => {
				...
				reset(div_4);
				template_effect(() => {
					set_attribute(div_4, "data-path", item().isDir ? item().path : "");
					set_text(text_5, item().size);
				});
				append($$anchor, div_4);
			};
			var d = /* @__PURE__ */ user_derived(() => hasColumn("size"));
			...
			var consequent_8 = ($$anchor) => {
				...
				reset(div_5);
				template_effect(() => {
					set_attribute(div_5, "data-path", item().isDir ? item().path : "");
					set_text(text_6, item().itemCount);
				});
				append($$anchor, div_5);
			};
			var d_1 = /* @__PURE__ */ user_derived(() => hasColumn("items"));
			...
			var consequent_9 = ($$anchor) => {
				...
				reset(div_6);
				template_effect(() => set_text(text_7, item().modified));
				append($$anchor, div_6);
			};
			var d_2 = /* @__PURE__ */ user_derived(() => hasColumn("date"));
			...
			var consequent_10 = ($$anchor) => {
				...
				reset(div_7);
				template_effect(() => set_text(text_8, item().type));
				append($$anchor, div_7);
			};
			var d_3 = /* @__PURE__ */ user_derived(() => hasColumn("type"));
			if_block(node_9, ($$render) => {
				if (get(d_3)) $$render(consequent_10);
			});
			template_effect(() => {
				set_text(text_3, item().icon);
				set_attribute(span_3, "title", item().name);
				set_text(text_4, item().name);
			});
			append($$anchor, fragment_5);
		};
		if_block(node, ($$render) => {
			if (isGrid()) $$render(consequent_4);
			else $$render(alternate_1, -1);
		});
		reset(div);
		template_effect(($0) => {
			set_class(div, 1, $0);
			set_attribute(div, "data-path", item().path);
			set_attribute(div, "data-index", item().index);
			set_attribute(div, "data-is-dir", item().isDir);
			set_attribute(div, "data-is-image", isGrid() ? item().isImage : void 0);
			set_attribute(div, "data-fixed-height", item().fixedHeight || void 0);
			set_attribute(div, "aria-selected", item().isSelected);
			set_attribute(div, "tabindex", item().isFocused ? 0 : -1);
		}, [() => clsx(itemClass(item()))]);
		delegated("click", div, (event) => emitItemInteraction("simplefile:file-list-item-click", event, item()));
		delegated("dblclick", div, (event) => emitItemInteraction("simplefile:file-list-item-open", event, item()));
		delegated("keydown", div, (event) => handleItemKeydown(event, item()));
		append($$anchor, div);
	};
	let isGrid = prop($$props, "isGrid", 3, false), items = prop($$props, "items", 19, () => []), mode = prop($$props, "mode", 3, "simple"), visibleColumns = prop($$props, "visibleColumns", 19, () => [
		"size",
		"date",
		"type"
	]);
	...
	function emitItemInteraction(type, event, item) {
	...
	var consequent_11 = ($$anchor) => {
		...
		each(div_9, 21, items, (item) => item.path, ($$anchor, item) => {
			fileItem($$anchor, () => get(item));
		});
		reset(div_9);
		reset(div_8);
		template_effect(() => set_class(div_9, 1, `virtual-content${isGrid() ? " virtual-content--grid" : ""}`));
		append($$anchor, div_8);
	};
	var consequent_12 = ($$anchor) => {
		var div_10 = root_12();
		each(div_10, 21, items, (item) => item.path, ($$anchor, item) => {
			fileItem($$anchor, () => get(item));
		});
		reset(div_10);
	...
	var alternate_2 = ($$anchor) => {
		...
		each(first_child(fragment_11), 17, items, (item) => item.path, ($$anchor, item) => {
			fileItem($$anchor, () => get(item));
		});
		append($$anchor, fragment_11);
	};
	if_block(node_10, ($$render) => {
		if (mode() === "virtual") $$render(consequent_11);
		else if (isGrid()) $$render(consequent_12, 1);
...
//#endregion
//#region src/lib/components/file-list/FileListSkeleton.svelte
var root = /* @__PURE__ */ from_html(`<div class="skeleton-item"><div class="skeleton skeleton-icon"></div> <div class="skeleton skeleton-text name"></div> <div class="skeleton skeleton-text size"></div> <div class="skeleton skeleton-text date"></div> <div class="skeleton skeleton-text type"></div></div>`);
function FileListSkeleton($$anchor, $$props) {
	let count = prop($$props, "count", 3, 8);
	function rows() {
		return Array.from({ length: Math.max(0, count()) }, (_, index) => index);
	}
	var fragment = comment();
	each(first_child(fragment), 16, rows, (row) => row, ($$anchor, row) => {
		append($$anchor, root());
	});
	append($$anchor, fragment);
}
//#endregion
//#region src/lib/components/file-list.ts
var mountedFileLists = /* @__PURE__ */ new WeakMap();
var mountedFileListSkeletons = /* @__PURE__ */ new WeakMap();
function clearMounted(target, map) {
...
function renderFileListSkeleton(target, props = {}) {
	if (!target) return;
	clearFileListItems(target);
	const component = mount(FileListSkeleton, {
		target,
		props: { count: props.count ?? 8 }
	});
	mountedFileListSkeletons.set(target, component);
}
//#endregion
export { clearFileListItems, renderFileListItems, renderFileListSkeleton };
