...
//#endregion
//#region src/lib/components/modal-body/ModalBody.svelte
function ModalBody($$anchor, $$props) {
	let bodyHtml = prop($$props, "bodyHtml", 3, "");
	var fragment = comment();
	html(first_child(fragment), bodyHtml);
	append($$anchor, fragment);
}
//#endregion
//#region src/lib/components/modal-body.ts
var mountedModalBodies = /* @__PURE__ */ new WeakMap();
function clearModalBody(target) {
	if (!target) return;
...
function renderModalBody(target, props = {}) {
	if (!target) return;
	clearModalBody(target);
	const component = mount(ModalBody, {
		target,
		props: { bodyHtml: props.bodyHtml ?? "" }
	});
	mountedModalBodies.set(target, component);
}
//#endregion
export { clearModalBody, renderModalBody };
