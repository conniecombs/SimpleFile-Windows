...
//#endregion
//#region src/lib/components/quick-look/QuickLookModal.svelte
var root = /* @__PURE__ */ from_html(`<div class="no-preview"><span class="icon" aria-hidden="true">&#128065;</span> <p>No preview available</p></div>`);
var root_1 = /* @__PURE__ */ from_html(`<img/>`);
var root_2 = /* @__PURE__ */ from_html(`<pre> </pre>`);
var root_3 = /* @__PURE__ */ from_html(`<embed class="quicklook-pdf" type="application/pdf"/>`);
var root_4 = /* @__PURE__ */ from_html(`<div class="no-preview"><span class="icon" aria-hidden="true">&#128213;</span> <p>PDF too large to preview</p></div>`);
var root_5 = /* @__PURE__ */ from_html(`<div class="preview-info"><p> </p> <p> </p></div>`);
var root_6 = /* @__PURE__ */ from_html(`<div class="quicklook-modal" id="quicklook-modal"><div class="quicklook-header"><span class="quicklook-title" id="quicklook-title"> </span> <button class="quicklook-close" id="quicklook-close" type="button" aria-label="Close quick look">&times;</button></div> <div class="quicklook-content" id="quicklook-content"><!></div> <div class="quicklook-footer"><span class="quicklook-info" id="quicklook-info"></span> <button class="btn btn-primary" id="quicklook-open" type="button">Open with Default App</button></div></div>`);
function QuickLookModal($$anchor, $$props) {
	push($$props, true);
	let legacyContent = prop($$props, "legacyContent", 3, null), preview = prop($$props, "preview", 3, null), title = prop($$props, "title", 3, "Preview");
	let contentElement = /* @__PURE__ */ state(void 0);
	let pdfUrl = /* @__PURE__ */ state(null);
	...
	function pdfBlobUrl(base64Content) {
	...
	user_effect(() => {
		...
		if (preview()?.file_type === "pdf" && preview().content) {
			...
			set(pdfUrl, activePdfUrl, true);
		}
		return revokePdfUrl;
	});
	user_effect(() => {
		if (!get(contentElement) || legacyContent() === null || legacyContent() === void 0) return;
		get(contentElement).replaceChildren();
		if (legacyContent() instanceof Node) get(contentElement).replaceChildren(legacyContent());
		else get(contentElement).innerHTML = legacyContent();
	});
	...
	var consequent_5 = ($$anchor) => {
		...
		var consequent_1 = ($$anchor) => {
			var img = root_1();
			template_effect(() => {
				set_attribute(img, "src", `data:${preview().mime_type};base64,${preview().content}`);
		...
		var consequent_2 = ($$anchor) => {
			...
			reset(pre);
			template_effect(() => set_text(text_1, preview().content || ""));
			append($$anchor, pre);
		};
		var consequent_4 = ($$anchor) => {
			...
			var consequent_3 = ($$anchor) => {
				var embed = root_3();
				template_effect(() => set_attribute(embed, "src", get(pdfUrl)));
				append($$anchor, embed);
			};
			...
			if_block(node_2, ($$render) => {
				if (get(pdfUrl)) $$render(consequent_3);
		...
		var alternate_1 = ($$anchor) => {
			...
			reset(div_5);
			template_effect(($0) => {
				set_text(text_2, `Type: ${preview().mime_type ?? ""}`);
				set_text(text_3, `Size: ${$0 ?? ""}`);
			}, [() => formatSize(preview().size)]);
			append($$anchor, div_5);
		};
		if_block(node_1, ($$render) => {
			if (!preview()) $$render(consequent);
			else if (preview().file_type === "image" && preview().content) $$render(consequent_1, 1);
			else if (preview().file_type === "text") $$render(consequent_2, 2);
			else if (preview().file_type === "pdf") $$render(consequent_4, 3);
			else $$render(alternate_1, -1);
		});
		append($$anchor, fragment);
	};
	if_block(node, ($$render) => {
		if (legacyContent() === null || legacyContent() === void 0) $$render(consequent_5);
	});
	reset(div_2);
	bind_this(div_2, ($$value) => set(contentElement, $$value), () => get(contentElement));
	next(2);
	reset(div);
...
//#endregion
//#region src/lib/components/quick-look.ts
var mountedQuickLooks = /* @__PURE__ */ new WeakMap();
function clearQuickLook(target) {
	if (!target) return;
...
function renderQuickLook(target, props) {
	if (!target) return;
...
//#endregion
export { clearQuickLook, renderQuickLook };
