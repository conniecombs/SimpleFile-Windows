...
public static class BinaryFrameCodec
{
    ...
    public static bool TryDecode(ReadOnlySpan<byte> payload, out BinaryFrameMessage? message)
    {
        ...
        {
            throw new InvalidOperationException($"Unsupported SimpleFile binary frame version {version}.");
        }
        ...
        message = tag switch
        {
            ...
            _ => throw new InvalidOperationException($"Unknown SimpleFile binary frame tag {tag}."),
        };
